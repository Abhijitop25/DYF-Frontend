...
const FlightResults = () => {
  ...
  const { origin, destination, departureDate, returnDate, travelClass, passengers } = location.state;
        ...
        {filteredFlights.map((flight) => (
          ...
          >
            ...
            <div className="text-right">
              ...
              {/* Booking Button */}
              <button className="mt-4 px-3 py-1 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">
                Book Now
              </button>
            </div>
          </div>
