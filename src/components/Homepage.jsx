        ...
        <form className="space-y-6" onSubmit={handleSearchFlights}>
          <div className="flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0">
            <div className="flex-1">
              ...
              <Select
                id="origin"
                options={cities} // Use the cities state here
                className="w-full"
                placeholder="Search or select origin city"
                value={origin}
                onChange={setOrigin}
                onMenuOpen={getCities} // Fetch cities when the dropdown opens
              />
            </div>
            <div className="flex-1">
          ...
          <div className="flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0">
            ...
            <div className="flex-1">
              <label className="block text-gray-700 font-medium mb-2" htmlFor="return-date">Return Date</label>
              <input
                type="date"
                id="return-date"
                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
